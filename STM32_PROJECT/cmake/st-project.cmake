...
# BASED ON d:\MCU_LAB\LAB_1\STM32_PROJECT
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mcpu=cortex-m3>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32F103C6UX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32F103C6UX_FLASH.ld>"
)
